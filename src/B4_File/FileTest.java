 ...
 * Se devono scrivere la stessa quantità di caratterei in una volta solo hanno
 * la stessa efficacia.
 * Se devono scrivere scrivere più volte sullo stesso file, il BufferedWriter è
 * più efficente,
 * perchè prima riempie il buffer e poi lo trascrive sul file in una volta sola.
 * Si da per assodato che accedere e scrivere sul file è molto più lento che
 * scrivere nel buffer
 */
...
public class FileTest {
	...
	public static void main(String[] args) {
		StringBuilder strBldrNormal = new StringBuilder(); // Stringhe da appoggio per memorizzare ciò che viene letto
															// da file.
		StringBuilder strBldrBuffer = new StringBuilder(); // Stringhe da appoggio per memorizzare ciò che viene letto
															// da file.
	 ...
	 * HARD perchè utilizza il metodo write() per ogni singolo carattere di
	 * copyString
	 * 
	 * @param fn_writeNormalHard File di destinazione sul quale voglio scrivere con
	 *                           il FileWriter
	 * @param fn_writeBufferHard File di destinazione sul quale voglio scrivere con
	 *                           il BufferWriter
	 * @param copyString         Stringa da copiare su entrambu i File
	 * @return writeTime[0] Tempo di scrittura del FileReader. writeTime[1] Tempo di
	 *         scrittura del BufferReader
	 */
	private static long[] writeTestHard(String fn_writeNormalHard, String fn_writeBufferHard,
	...
	/**
	 * Confronto i tempi di scrittura tra FileWriter e BufferedWriter.
	 * EASY perchè utilizza il metodo write() per tutta l'intera stringa di
	 * copyString
	 * 
	 * @param fn_writeNormalHard File di destinazione sul quale voglio scrivere con
	 *                           il FileWriter
	 ...
	 *         scrittura del BufferReader
	 */
	private static long[] writeTestEasy(String fn_writeNormalEasy, String fn_writeBufferEasy,
			StringBuilder copyString) {
		long writeTime[] = new long[2];
		long initialTime;
	 ...
	 * 
	 * @param fn_read       File di partenza da quale voglio leggere sia con
	 *                      BufferedReader che con FileReader
	 * @param strBldrNormal StringBuilder sul quale riscrivo i dati letti con
	 *                      FileReader
	 * @param strBldrBuffer StringBuilder sul riscrivo i dati letti con
	 *                      BufferedReader
	 * @return readTime[0] Tempo di lettura del FileReader. readTime[1] Tempo di
	 *         lettura del BufferedReader
	 */
	 ...
	 * 
	 * @param fr            FileReader
	 * @param strBldrNormal StringBuilder sul quale salvo i dati letti con
	 *                      FileReader
	 ...
	 * @param strBldrBuffer StringBuilder sul quale salvo i dati letti con
	 *                      BufferedReader
	...
	private static long readBuffer(BufferedReader br, StringBuilder strBldrBuffer) throws IOException {
		...
		while ((readLine = br.readLine()) != null) { // When the "End Of File" is reached the readline() method returns
														// null
